...
The following licensing conditions apply to works created at [Hack Darmstadt 2017](http://hackdarmstadt.de):
...
We encourage you to publish any data sources created at [Hack Darmstadt 2017](http://hackdarmstadt.de) under an open data license (we suggest [ODbL](http://wiki.openstreetmap.org/wiki/Open_Database_License)).
